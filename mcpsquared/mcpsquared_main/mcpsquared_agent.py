...
import logging
import traceback
from mcpsquared_base.utils.workflow_runner import run_workflow, _load_workflow_config
from mcpsquared_base.utils.agent_loader import _load_json_config
from mcpsquared_base.tools.chain_selection import (
    get_last_chain_file, 
...
class MCPSquaredAgent:
    ...
    def _setup_agent(self):
        ...
        self.agent = self._create_mcp_agent()
    ...
    def _create_mcp_agent(self):
        """Create MCPAgent with LangChain integration"""
        return MCPAgent(
    ...
    def _build_phase_tools_base_config(self, mcpsquared_dir: str) -> Dict[str, Any]:
        ...
        phase_tools_server_path = os.getenv("PHASE_TOOLS_MCP_SERVER_PATH")
        if not phase_tools_server_path:
            raise ValueError("PHASE_TOOLS_MCP_SERVER_PATH environment variable not set")
        return {
            "command": "python",
            "args": [phase_tools_server_path],
            "transport": "stdio"
        }
